  ...
  return (
    ...
    <div class="max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
        <div class="grid grid-cols-2 gap-8 md:grid-cols-3 lg:grid-cols-5">
            ...
            <div>
                ...
                <ul class="text-gray-500 dark:text-gray-400">
                    ...
                    <li class="mb-4">
                        <Link to="#" class="hover:underline">Terms</Link>
                    </li>
                </ul>
            </div>
            <div>
        ...
        <div class="text-center">
            ...
            <span class="block text-sm text-center text-gray-500 dark:text-gray-400">© 2025 Landwind. All Rights Reserved. Built with <Link to="https://flowbite.com" class="text-purple-600 hover:underline dark:text-purple-500">Flowbite</Link> and <Link to="https://tailwindcss.com" class="text-purple-600 hover:underline dark:text-purple-500">Tailwind CSS</Link>.
            </span>
            <ul class="flex justify-center mt-5 space-x-5">
                <li>
                    <Link to="#" class="text-gray-500 hover:text-gray-900 dark:hover:text-white dark:text-gray-400">
